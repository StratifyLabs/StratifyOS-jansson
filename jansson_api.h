...
typedef struct {
    ...
    int (*unpack_ex)(json_t *root, json_error_t *error, size_t flags, const char *fmt, ...);
    int (*vunpack_ex)(json_t *root, json_error_t *error, size_t flags, const char *fmt, va_list ap);
